      ...
      {activeTab === 'overview' ? (
        ...
        <div className="flex flex-wrap items-center gap-2 lg:justify-end">
          ...
          {compareRangeKey === 'custom' ? (
            <>
              <CompactDateField label="From" max={customToDate} onChange={onCustomFromDateChange} value={customFromDate} />
              <CompactDateField label="To" min={customFromDate} onChange={onCustomToDateChange} value={customToDate} />
            </>
          ) : null}
        </div>
      )}
