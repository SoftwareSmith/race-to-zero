      ...
      {COMPARE_RANGE_OPTIONS.map((option) => {
        ...
        return (
          <button
            ...
            className={cn(
              "h-8.5 cursor-pointer rounded-full border px-3 text-[0.78rem] font-semibold transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300/40 sm:h-9 sm:px-3.5 sm:text-[0.82rem]",
              isActive
